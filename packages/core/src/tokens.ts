...
export function getTokensForNetwork(network: Network): TokenInfo[] {
...
export function getNFTCollections(network: Network): TokenInfo[] {
  return TOKENS.filter((t) => t.assetType === 'ERC721' && t.addresses[network] !== undefined)
}
