  ...
  contracts: {
    [CONTRACT_ADDRESS]: {
      methods: [
        ...
        { name: 'Settle Collection', entrypoint: 'settle_collection' },
        { name: 'Refinance', entrypoint: 'refinance' },
        { name: 'Commit Renegotiation', entrypoint: 'commit_renegotiation' },
        { name: 'Execute Renegotiation', entrypoint: 'execute_renegotiation' },
        { name: 'Buy Collateral', entrypoint: 'buy_collateral' },
