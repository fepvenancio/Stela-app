...
export default function InscriptionPage({ params }: InscriptionPageProps) {
  ...
  if (!isValidId) return <div className="py-24 text-center"><p className="text-nova text-sm mb-4">Invalid inscription ID</p><Link href="/browse" className="text-star text-sm hover:underline">Back to Browse</Link></div>
