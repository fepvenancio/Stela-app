...
export default function InscriptionPage({ params }: InscriptionPageProps) {
  ...
  if (!isValidId) return <div className="py-24 text-center"><p className="text-nova text-sm mb-4">Invalid inscription ID</p><Link href="/stelas" className="text-star text-sm hover:underline">Back to Stelas</Link></div>
  ...
  return (
    <div className="animate-fade-in max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <Link href="/stelas" className="text-ash hover:text-star transition-colors text-sm flex items-center gap-2 group">
