      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        {canRemove && (
          <button
            type="button"
            onClick={onRemove}
            className="flex items-center justify-center w-11 h-11 rounded-xl text-gray-500 hover:text-nova hover:bg-red-500/10 transition-colors cursor-pointer shrink-0 opacity-0 group-hover:opacity-100 focus:opacity-100"
