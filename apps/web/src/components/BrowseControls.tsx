    ...
    <div className="flex flex-col md:flex-row items-center gap-4 mb-6">
      <div className="relative flex-1 w-full">
        ...
        <Input
          ...
          aria-label="Search inscriptions by token symbol or address"
        />
      </div>
      ...
      <div className="flex items-center gap-2 w-full md:w-auto">
        <div className="flex items-center gap-2 bg-surface/40 border border-edge/50 rounded-xl px-2">
          ...
          <Select value={sortBy} onValueChange={(v) => onSortChange(v as SortOption)}>
            <SelectTrigger className="border-0 bg-transparent focus:ring-0 w-[160px] text-sm text-dust hover:text-chalk" aria-label="Sort inscriptions">
