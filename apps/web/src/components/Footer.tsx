      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-12 py-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
            ...
            <Link href="/nft" className="text-xs text-dust hover:text-chalk transition-colors">NFT</Link>
            <Link href="/faucet" className="text-xs text-dust hover:text-chalk transition-colors">Faucet</Link>
            <span className="hidden sm:block w-px h-3 bg-edge/30" />
            <Link href="/docs" className="text-xs text-dust hover:text-chalk transition-colors inline-flex items-center gap-1.5">
